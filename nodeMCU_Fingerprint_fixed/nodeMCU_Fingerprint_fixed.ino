...
const char *ssid = "Yilma";  //ENTER YOUR WIFI SETTINGS
const char *password = "passcode";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.1.7/biometricattendance/getdata.php"; //computer IP or the server domain
...
void SendFingerprintID( int finger ){
  ...
  http.begin(client, "192.168.1.7"); //initiate HTTP request, put your Website URL or Your Computer IP 
